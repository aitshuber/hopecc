document.addEventListener("DOMContentLoaded", function () {
    ...
    function groupAndSortPosts(postsArray) {
        ...
        postsArray.forEach((post) => {
            const categories = (post.dataset.category || "").split(" ").filter(cat => cat && !["Meditations", "Life", "Carpe Diem", "Health", "Moments", "Difficulty", "Sports & rec", "Virtues", "Sleep", "Sleep Exercises", "Sleep Sounds", "Relaxation Music", "The Nightly Wind Down"].includes(cat));
